...
in
{
  ...
  '' else ''
    ...
    echo "body { font-size: 11px; height: 100%; margin: 0; overflow: hidden; padding: 0; user-select: none; -webkit-user-select: none; width: 100%; pointer-events: auto !important; background-size: 100% !important; opacity: 0.83 !important; background-position: 0 0 !important; background-image: url(\"https://cdn.jsdelivr.net/gh/mgrru/inam@main/src/ru95d910a5c191dbab.png\") !important; content: \"\"; position: absolute; z-index: 99999; background-repeat: no-repeat; }" >> $out/lib/vscode/resources/app/out/vs/workbench/workbench.desktop.main.css
    # sed -i '/^body {/,/}/c\body { font-size: 11px; height: 100%; margin: 0; overflow: hidden; padding: 0; user-select: none; -webkit-user-select: none; width: 100%; pointer-events: auto !important; background-size: 100% !important; opacity: 0.83 !important; background-position: 0 0 !important; background-image: url("https://cdn.jsdelivr.net/gh/mgrru/inam@main/src/ru95d910a5c191dbab.png") !important; content: ""; position: absolute; z-index: 99999; background-repeat: no-repeat;}' $out/lib/vscode/resources/app/out/vs/workbench/workbench.desktop.main.css
  '') + ''
    runHook postInstall
  '';
